...
namespace AniDroid.Adapters.MediaAdapters
{
    public class DiscoverMediaRecyclerAdapter : LazyLoadingRecyclerViewAdapter<Media>
    {
        ...
        public DiscoverMediaRecyclerAdapter(BaseAniDroidActivity context, IAsyncEnumerable<OneOf<IPagedData<Media>, IAniListError>> enumerable) : base(context, enumerable, RecyclerCardType.Vertical)
        {
